...
public class CountryUtils {
    ...
    public static int getFlagDrawableResId(String country) {
        switch (country) {
            case "ac": //Ascension Island
                return R.drawable.flag_ascension_island_s;
            case "af": //afghanistan
            ...
            case "ax": //Aland Islands
                return R.drawable.flag_aland_islands_s;
            case "az": //azerbaijan
            ...
            case "bq": //Caribbean Netherlands
                return R.drawable.flag_caribbean_netherlands_s;
            case "bv": //Bouvet Island
                return R.drawable.flag_bouvet_island_s;
            case "mm": //myanmar
            ...
            case "cw": //Curaçao
                return R.drawable.flag_curacao_s;
            case "hr": //croatia
            ...
            case "eh": //Western Sahara
                return R.drawable.flag_western_sahara_s;
            case "fx": //France Metropolitan
                return R.drawable.flag_france_metropolitan_s;
            case "gg": //Guernsey
                return R.drawable.flag_guernsey_s;
            case "gp": //Guadeloupe
                return R.drawable.flag_guadeloupe_s;
            case "gs": //South Georgia and the South Sandwich Islands
                return R.drawable.flag_south_georgia_and_the_south_sandwich_islands_s;
            case "gu": //Guam
                return R.drawable.flag_guam;
            case "hm": //Heard and Mcdonald Islands
                return R.drawable.flag_heard_and_mcdonaid_islands_s;
            case "io": //British Indian Ocean Territory
                return R.drawable.flag_british_indian_ocean_territory_s;
            case "is": //Iceland
                return R.drawable.flag_iceland;
            case "je": //Jersey
                return R.drawable.flag_jersey_s;
            case "mf": //Collectivity of Saint Martin
                return R.drawable.flag_collectivity_of_saint_martin_s;
            case "mp": //Northern Mariana Islands
                return R.drawable.flag_northern_mariana_islands_s;
            case "nf": //Norfolk Island
                return R.drawable.flag_norfolk_island;
            case "ps": //State of Palestine
                return R.drawable.flag_state_of_palestine_s;
            case "sj": //Svalbard and Jan Mayen Islands
                return R.drawable.flag_svalbard_and_jan_mayen_islands_s;
            case "ss": //South Sudan
                return R.drawable.flag_south_sudan_s;
            case "tf": //French Southern Territories
                return R.drawable.flag_french_southern_territories_s;
            case "um": //United States Minor Outlying Islands
                return R.drawable.flag_united_states_minor_outlying_islands_s;
            case "xk": //Kosovo
                return R.drawable.flag_kosovo_s;
            default:
    ...
    public static List<Country> getAllCountries(Context context) {
        ...
        //TODO New Added
        countries.add(new Country(context.getString(R.string.country_ascension_island_code),
                context.getString(R.string.country_ascension_island_number),
                context.getString(R.string.country_ascension_island_name)));
        ...
        countries.add(new Country(context.getString(R.string.country_caribbean_netherlands_code),
                context.getString(R.string.country_caribbean_netherlands_number),
                context.getString(R.string.country_caribbean_netherlands_name)));

        countries.add(new Country(context.getString(R.string.country_western_sahara_code),
                context.getString(R.string.country_western_sahara_number),
                context.getString(R.string.country_western_sahara_name)));

        countries.add(new Country(context.getString(R.string.country_france_metropolitan_code),
                context.getString(R.string.country_france_metropolitan_number),
                context.getString(R.string.country_france_metropolitan_name)));
        ...
        countries.add(new Country(context.getString(R.string.country_south_georgia_and_the_south_sandwich_islands_code),
                context.getString(R.string.country_south_georgia_and_the_south_sandwich_islands_number),
                context.getString(R.string.country_south_georgia_and_the_south_sandwich_islands_name)));
        ...
        countries.add(new Country(context.getString(R.string.country_heard_and_mcdonaid_islands_code),
                context.getString(R.string.country_heard_and_mcdonaid_islands_number),
                context.getString(R.string.country_heard_and_mcdonaid_islands_name)));
        ...
        countries.add(new Country(context.getString(R.string.country_collectivity_of_saint_martin_code),
                context.getString(R.string.country_collectivity_of_saint_martin_number),
                context.getString(R.string.country_collectivity_of_saint_martin_name)));
        ...
        countries.add(new Country(context.getString(R.string.country_state_of_palestine_code),
                context.getString(R.string.country_state_of_palestine_number),
                context.getString(R.string.country_state_of_palestine_name)));

        countries.add(new Country(context.getString(R.string.country_svalbard_and_jan_mayen_islands_code),
                context.getString(R.string.country_svalbard_and_jan_mayen_islands_number),
                context.getString(R.string.country_svalbard_and_jan_mayen_islands_name)));
        ...
        countries.add(new Country(context.getString(R.string.country_french_southern_territories_code),
                context.getString(R.string.country_french_southern_territories_number),
                context.getString(R.string.country_french_southern_territories_name)));

        countries.add(new Country(context.getString(R.string.country_united_states_minor_outlying_islands_code),
                context.getString(R.string.country_united_states_minor_outlying_islands_number),
                context.getString(R.string.country_united_states_minor_outlying_islands_name)));
